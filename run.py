...
if __name__ == "__main__":
    ...
    if args.d:
        ...
        os.system('mysql --defaults-file=private_mysql_config.cnf -e "DROP DATABASE IF EXISTS {name};"'.format(name=private_config.DATABASE_NAME))
        print("Database deleted!")
        os.system('mysql --defaults-file=private_mysql_config.cnf -e "CREATE DATABASE IF NOT EXISTS {name} CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"'.format(name=private_config.DATABASE_NAME))
